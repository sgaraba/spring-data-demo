...
public class UserService {
    ...
    public UserEntity create(CreateUserEntityDto user) {
    ...
    public Optional<UserEntity> update(Long id, CreateUserEntityDto incoming) {
    ...
    public Optional<UserEntity> patch(Long id, CreateUserEntityDto incoming) {
